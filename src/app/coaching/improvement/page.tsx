...
function tone(status: OverallImprovementStatus) { if (status === "improved") return "success"; if (status === "declined" || status === "source_unavailable") return "destructive"; return "warning"; }
